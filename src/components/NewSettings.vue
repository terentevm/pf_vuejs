    ...
    <v-stepper v-model="e1">
        ...
        <v-stepper-items>
            <v-stepper-content step="1">
                ...
                <v-btn v-show="!sending" color="primary" @click='saveCurrencies' :disabled="currensySaved">Save</v-btn>
                <v-progress-circular v-show="sending" indeterminate :size="50" color="primary"></v-progress-circular>
        ...
        <v-card-text>
          <v-container grid-list-md>
            ...
            <v-card-actions>
                ...
                <v-btn :disabled="sending" color="success" block @click.native="saveWallet()">Save</v-btn>
                </v-card-actions>
                </v-card>
            ...
            <v-stepper-content step="3">
                <v-card>
                    ...
                    <v-card-actions>
                        ...
                        <v-btn :disabled="sending" color="success" block @click="saveSettings()">Complete</v-btn>
                    </v-card-actions>   
                </v-card>
            </v-stepper-content>
        </v-stepper-items>
...
export default {
  ...
  methods: {
    ...
    saveSettings(){
        ...
        Model.saveSettings(this.defaults, false).then(()=>{
            this.sending = false; 
