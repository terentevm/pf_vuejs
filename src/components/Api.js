...
import config_prod from '../api/config_prod';
import config_dev from '../api/config_dev';
...
class Api {
  ...
  async save(params) {
    ...
    let fullUrl = `${this.host}/${model}/create?XDEBUG_SESSION_START=13040`;
    if (params.isUpdate === true) {
      fullUrl = `${this.host}/${model}/update?XDEBUG_SESSION_START=13040`;
    }
